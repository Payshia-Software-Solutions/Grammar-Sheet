      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
        ...
        <Card className="shadow-xl rounded-2xl">
          <CardContent className="p-8 text-center flex flex-col items-center">
            <div className="w-16 h-16 mb-6 rounded-full flex items-center justify-center bg-green-100">
            ...
            <Button asChild className="bg-green-500 hover:bg-green-600 text-white rounded-lg w-full">
        ...
        <Card className="shadow-xl rounded-2xl">
          <CardContent className="p-8 text-center flex flex-col items-center">
            <div className="w-16 h-16 mb-6 rounded-full flex items-center justify-center bg-blue-100">
            ...
            <Button asChild className="bg-blue-500 hover:bg-blue-600 text-white rounded-lg w-full">
        ...
        <Card className="shadow-xl rounded-2xl">
          <CardContent className="p-8 text-center flex flex-col items-center">
             <div className="w-16 h-16 mb-6 rounded-full flex items-center justify-center bg-orange-100">
